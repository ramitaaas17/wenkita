...
export default function LoginForm({ onSwitchToRegister, onClose }: LoginFormProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-8">
      ...
      {/* Social Login Button */}
      <button className="w-full flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-xl hover:border-gray-300 hover:shadow-md transition-all duration-300 group mb-8">
